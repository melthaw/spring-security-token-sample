package in.clouthink.daas.security.token.sample.attempt;
...
@EnableScheduling
@EnableToken
public class LoginAttemptSampleApplication extends SpringBootServletInitializer {
...
//    }
    ...
    public static void main(String[] args) {
        SpringApplication.run(new Object[]{LoginAttemptSampleApplication.class}, args);
    }
